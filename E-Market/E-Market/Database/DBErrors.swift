...
enum DBErrors: String, Error {
    ...
    case deleteObjectError = "Failed to delete the object from the database. Please ensure the object exists and try again."
    case fetchDataError    = "Failed to fetch data from the database. Please check your connection or try again later."
    case updateObjectError = "Failed to update the object in the database. Please check your input and try again."
